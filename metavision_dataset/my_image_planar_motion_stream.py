...
from .my_camera_poses import My_CameraPoseGenerator


class My_PlanarMotionStream(object):
    """
    ...
    def __init__(self, image_filename, height, width, max_frames=1000, rgb=False, infinite=True,
        ...
        self.camera = My_CameraPoseGenerator(self.frame_height, self.frame_width, self.max_frames, pause_probability,
