...
class ComputeKPI:
    ...
    def __init__(self, npy_folder_path, interval):
        """
        ...
        # self.delta_t_list = [25091, 25091*2, 25091*4, 25091*6, 25091*8]
        assert interval == 25000 or interval == 25091
        if interval == 25000:
            self.window_size = 10000
        else:
            self.window_size = interval / 10.0
        print('window_size: ', self.window_size)
        self.delta_t_list = [interval, interval*2, interval*4, interval*6, interval*8]
        # self.window_size = interval / 10   # 25000
    ...
    def compute(self):
        ...
        for file_path in self.npy_file_list:
            ...
            track_length_list.append(total_track_length * 1e-6)
...
if __name__ == '__main__':
    ...
    kpicomputer = ComputeKPI(params.folder_path, params.time_interval)
